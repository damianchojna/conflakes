...
const BuildConfigFromDist_1 = require("../../src/BuildConfigFromDist");
describe('BuildConfigFromDist', () => {
    let distBuild;
    var writeFileSyncMock;
    beforeEach(function () {
        distBuild = new BuildConfigFromDist_1.BuildConfigFromDist();
    ...
    describe('JSON merge', () => {
        it('Should throw exception when given file is not exist', () => {
            ...
            }).to.throw(Error, BuildConfigFromDist_1.BuildConfigFromDist.errorMessages.fileNotExist + 'non_exist.dist.json');
        });
        it('Should throw exception when no valid json given', () => {
            ...
            }).to.throw(Error, BuildConfigFromDist_1.BuildConfigFromDist.errorMessages.problemWithFile + inputFile);
        });
        it('Should throw exception when given file name does not contain the "dist" word', () => {
            ...
            expect(() => {
                distBuild.merge(inputFile);
            }).to.throw(Error, BuildConfigFromDist_1.BuildConfigFromDist.errorMessages.notValidDistFileName + 'valid.json');
        });
        it('Should throw exception when output file has not valid json', () => {
            ...
            expect(() => {
                distBuild.merge(inputFile);
            }).to.throw(Error, BuildConfigFromDist_1.BuildConfigFromDist.errorMessages.problemWithFile + outputFile);
        });
